// http bhi ek object h jisko humne phle import kiya
const http = require("http");

// data h jo ki array ki andar object h
const gitHub = [
  {
    login: "mojombo",
    id: 1,
  ...
  },
  {
    ...
    following_url:
      "https://api.github.com/users/sethfitz/following{/other_user}",
    ...
    received_events_url:
      "https://api.github.com/users/sethfitz/received_events",
    type: "User",
    user_view_type: "public",
    site_admin: false,
  },
  ...
  },
  {
    ...
    following_url:
      "https://api.github.com/users/joshknowles/following{/other_user}",
    gists_url: "https://api.github.com/users/joshknowles/gists{/gist_id}",
    starred_url:
      "https://api.github.com/users/joshknowles/starred{/owner}{/repo}",
    ...
    received_events_url:
      "https://api.github.com/users/joshknowles/received_events",
    type: "User",
    user_view_type: "public",
    site_admin: false,
  },
  {
    ...
    following_url:
      "https://api.github.com/users/hornbeck/following{/other_user}",
    ...
    received_events_url:
      "https://api.github.com/users/hornbeck/received_events",
    type: "User",
    user_view_type: "public",
    site_admin: false,
  },
  {
    ...
    following_url:
      "https://api.github.com/users/jwhitmire/following{/other_user}",
    gists_url: "https://api.github.com/users/jwhitmire/gists{/gist_id}",
    starred_url:
      "https://api.github.com/users/jwhitmire/starred{/owner}{/repo}",
    ...
    received_events_url:
      "https://api.github.com/users/jwhitmire/received_events",
    type: "User",
    user_view_type: "public",
    site_admin: false,
  },
  {
    login: "elbowdonkey",
    id: 51,
    node_id: "MDQ6VXNlcjUx",
    avatar_url: "https://avatars.githubusercontent.com/u/51?v=4",
    gravatar_id: "",
  ...
  },
  {
    ...
    avatar_url: "https://avatars.githubusercontent.com/u/52?v=4",
    gravatar_id: "",
  ...
  },
  {
    ...
    gravatar_id: "",
    url: "https://api.github.com/users/knzai",
    html_url: "https://github.com/knzai",
    followers_url: "https://api.github.com/users/knzai/followers",
    following_url: "https://api.github.com/users/knzai/following{/other_user}",
    gists_url: "https://api.github.com/users/knzai/gists{/gist_id}",
    starred_url: "https://api.github.com/users/knzai/starred{/owner}{/repo}",
    subscriptions_url: "https://api.github.com/users/knzai/subscriptions",
    organizations_url: "https://api.github.com/users/knzai/orgs",
    repos_url: "https://api.github.com/users/knzai/repos",
    events_url: "https://api.github.com/users/knzai/events{/privacy}",
    received_events_url: "https://api.github.com/users/knzai/received_events",
    type: "User",
    user_view_type: "public",
    site_admin: false,
  },
  ...
  },
  {
    ...
    following_url:
      "https://api.github.com/users/rsanheim/following{/other_user}",
    ...
    received_events_url:
      "https://api.github.com/users/rsanheim/received_events",
    type: "User",
    user_view_type: "public",
    site_admin: false,
  },
  {
    ...
    following_url:
      "https://api.github.com/users/schacon/following{/other_user}",
  ...
  },
  {
    ...
    following_url:
      "https://api.github.com/users/uggedal/following{/other_user}",
...
// http object ke andar ek method h create server jo ki ek call back function leta h and yeh parmater 2 leta h request and response
// req and resp bhi object h jisme hum bhaut saari properties dekhete h jese resp me end, send
...
// jo http hume object de raa tha and humne server create kia woh bhi return me ek object deta h jisme listen method h jisme p hum port number daalte h ki kis port number p listen krna h yeh mene port number daala toh ispe request listen hogi 3000 p

// port number
// IP Address → Kis machine par jana hai.
// Port Number → Us machine ke kis application ke paas jana hai.
// HTTP/HTTPS → Us application se baat kaise karni hai (rules/protocol)

// database kaa alag port number hota h
